...
export function TicketList({ tickets, loading, onTicketChange, selectedEvent }: TicketListProps) {
  const { user } = useAuth();
        ...
        <CardContent className="py-10 text-center">
          ...
          {isOrganizer && (
            <p className="text-gray-500 mt-2">
              As an organizer, you can create tickets for this event using the &quot;Create Ticket&quot; button above.
            </p>
          )}
        </CardContent>
      </Card>
